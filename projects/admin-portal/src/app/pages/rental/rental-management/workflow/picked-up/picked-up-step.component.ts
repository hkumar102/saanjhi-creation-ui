...
@Component({
    selector: 'app-rental-pickedup-step',
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
    ...
    templateUrl: './picked-up-step.component.html'
})
export class RentalPickedUpStepComponent implements OnInit {
    ...
    stepStatus = RentalStatus.PickedUp;
